...
import dwa.Dwa;
import dwa.http.APIServlet;
import dwa.http.APITag;
...
public final class AddOns {
    ...
    static {
        ...
        Dwa.getStringListProperty("dwa.addOns").forEach(addOn -> {
            try {
        ...
        if (!addOns.isEmpty() && !Dwa.getBooleanProperty("dwa.disableSecurityPolicy")) {
            System.setProperty("java.security.policy", Dwa.isDesktopApplicationEnabled() ? "dwadesktop.policy" : "dwa.policy");
