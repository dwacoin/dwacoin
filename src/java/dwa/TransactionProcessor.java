...
public interface TransactionProcessor extends Observable<List<? extends Transaction>,TransactionProcessor.Event> {
    ...
    long countUnconfirmedTransaction();
    ...
    void broadcast(Transaction transaction) throws DwaException.ValidationException;

    void processPeerTransactions(JSONObject request) throws DwaException.ValidationException;
    ...
    List<Transaction> restorePrunableData(JSONArray transactions) throws DwaException.NotValidException;
}
