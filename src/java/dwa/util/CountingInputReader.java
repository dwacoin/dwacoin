...
import dwa.DwaException.DwaIOException;
...
public class CountingInputReader extends FilterReader {
     ...
     * @throws  DwaIOException      Maximum count exceeded
     */
    private void incCount(long c) throws DwaIOException {
        count += c;
        if (count > limit)
            throw new DwaIOException("Maximum size exceeded: " + count);
    }
}
