...
public class UPnP {
    ...
    private static void init() {
        ...
        try {
            ...
            GatewayDevice.setHttpReadTimeout(Dwa.getIntProperty("dwa.upnpGatewayTimeout", GatewayDevice.getHttpReadTimeout()));
            GatewayDiscover discover = new GatewayDiscover();
            discover.setTimeout(Dwa.getIntProperty("dwa.upnpDiscoverTimeout", discover.getTimeout()));
