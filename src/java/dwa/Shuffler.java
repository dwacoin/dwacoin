...
public final class Shuffler {
    ...
    private static final int MAX_SHUFFLERS = Dwa.getIntProperty("dwa.maxNumberOfShufflers");
    ...
    private static void scheduleExpiration(Shuffling shuffling) {
        int expirationHeight = Dwa.getBlockchain().getHeight() + 720;
    ...
    private volatile DwaException.NotCurrentlyValidException failureCause;
    ...
    public DwaException.NotCurrentlyValidException getFailureCause() {
        return failureCause;
    }
    ...
    private void submitTransaction(Attachment.ShufflingAttachment attachment) {
        ...
        try {
            Transaction.Builder builder = Dwa.newTransactionBuilder(Crypto.getPublicKey(secretPhrase), 0, 0,
                    (short) 1440, attachment);
            builder.timestamp(Dwa.getBlockchain().getLastBlockTimestamp());
            ...
            if (participantAccount == null || transaction.getFeeNQT() > participantAccount.getUnconfirmedBalanceNQT()) {
                ...
                failureCause = new DwaException.NotCurrentlyValidException("Insufficient balance");
    ...
    public static class ShufflerException extends DwaException {
