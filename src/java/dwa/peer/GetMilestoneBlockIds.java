    ...
    JSONStreamAware processRequest(JSONObject request, Peer peer) {
        ...
        try {
            ...
            if (lastBlockIdString != null) {
                ...
                long myLastBlockId = Dwa.getBlockchain().getLastBlock().getId();
                if (myLastBlockId == lastBlockId || Dwa.getBlockchain().hasBlock(lastBlockId)) {
            ...
            if (lastMilestoneBlockIdString != null) {
                Block lastMilestoneBlock = Dwa.getBlockchain().getBlock(Convert.parseUnsignedLong(lastMilestoneBlockIdString));
            ...
            blockId = Dwa.getBlockchain().getBlockIdAtHeight(height);
