...
import dwa.Dwa;
import dwa.env.service.DwaService_ServiceManagement;
...
public class ManifestGenerator {
    ...
    public static void main(String[] args) {
        ...
        manifestGenerator.generate("./resource/dwa.manifest.mf", Dwa.class.getCanonicalName(), "./lib");
        String serviceClassName = DwaService_ServiceManagement.class.getCanonicalName();
        serviceClassName = serviceClassName.substring(0, serviceClassName.length() - "_ServiceManagement".length());
        manifestGenerator.generate("./resource/dwaservice.manifest.mf", serviceClassName, "./lib");
    }
