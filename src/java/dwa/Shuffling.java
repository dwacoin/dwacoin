...
import dwa.crypto.AnonymouslyEncryptedData;
...
public final class Shuffling {
    ...
    private static final boolean deleteFinished = Dwa.getBooleanProperty("dwa.deleteFinishedShufflings");
    ...
    private void cancel(Block block) {
        ...
        if (blamedAccountId != 0) {
            ...
            for (int i = 0; i < 3; i++) {
                ...
                Logger.logDebugMessage("Shuffling penalty %f DWA awarded to forger at height %d", ((double)fee) / Constants.ONE_DWA, block.getHeight() - i - 1);
            }
            ...
            Logger.logDebugMessage("Shuffling penalty %f DWA awarded to forger at height %d", ((double)fee) / Constants.ONE_DWA, block.getHeight());
        }
