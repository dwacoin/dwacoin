...
public abstract class CurrencyExchangeOffer {
    ...
    static void exchangeCurrencyForDWA(Transaction transaction, Account account, final long currencyId, final long rateNQT, final long units) {
    ...
    static void exchangeDWAForCurrency(Transaction transaction, Account account, final long currencyId, final long rateNQT, final long units) {
    ...
    CurrencyExchangeOffer(long id, long currencyId, long accountId, long rateNQT, long limit, long supply,
        ...
        this.creationHeight = Dwa.getBlockchain().getHeight();
