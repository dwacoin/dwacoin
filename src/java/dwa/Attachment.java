...
public interface Attachment extends Appendix {
    ...
    abstract class AbstractAttachment extends Appendix.AbstractAppendix implements Attachment {
        ...
        @Override
        final void validate(Transaction transaction) throws DwaException.ValidationException {
        ...
        final int getFinishValidationHeight(Transaction transaction) {
            return isPhased(transaction) ? transaction.getPhasing().getFinishHeight() - 1 : Dwa.getBlockchain().getHeight();
        }
    ...
    final class MessagingAliasAssignment extends AbstractAttachment {
        ...
        MessagingAliasAssignment(ByteBuffer buffer, byte transactionVersion) throws DwaException.NotValidException {
            super(buffer, transactionVersion);
    ...
    final class MessagingAliasSell extends AbstractAttachment {
        ...
        MessagingAliasSell(ByteBuffer buffer, byte transactionVersion) throws DwaException.NotValidException {
            super(buffer, transactionVersion);
    ...
    final class MessagingAliasBuy extends AbstractAttachment {
        ...
        MessagingAliasBuy(ByteBuffer buffer, byte transactionVersion) throws DwaException.NotValidException {
            super(buffer, transactionVersion);
            this.aliasName = Convert.readString(buffer, buffer.get(), Constants.MAX_ALIAS_LENGTH);
        }
    ...
    final class MessagingAliasDelete extends AbstractAttachment {
        ...
        MessagingAliasDelete(final ByteBuffer buffer, final byte transactionVersion) throws DwaException.NotValidException {
            super(buffer, transactionVersion);
            this.aliasName = Convert.readString(buffer, buffer.get(), Constants.MAX_ALIAS_LENGTH);
        }
    ...
    final class MessagingPollCreation extends AbstractAttachment {
        ...
        MessagingPollCreation(ByteBuffer buffer, byte transactionVersion) throws DwaException.NotValidException {
            super(buffer, transactionVersion);
            ...
            if (numberOfOptions > Constants.MAX_POLL_OPTION_COUNT) {
                throw new DwaException.NotValidException("Invalid number of poll options: " + numberOfOptions);
            }
    ...
    final class MessagingVoteCasting extends AbstractAttachment {
        ...
        public MessagingVoteCasting(ByteBuffer buffer, byte transactionVersion) throws DwaException.NotValidException {
            super(buffer, transactionVersion);
            pollId = buffer.getLong();
            int numberOfOptions = buffer.get();
            if (numberOfOptions > Constants.MAX_POLL_OPTION_COUNT) {
                throw new DwaException.NotValidException("More than " + Constants.MAX_POLL_OPTION_COUNT + " options in a vote");
            }
    ...
    final class MessagingPhasingVoteCasting extends AbstractAttachment {
        ...
        MessagingPhasingVoteCasting(ByteBuffer buffer, byte transactionVersion) throws DwaException.NotValidException {
            super(buffer, transactionVersion);
            ...
            if (secretLength > Constants.MAX_PHASING_REVEALED_SECRET_LENGTH) {
                throw new DwaException.NotValidException("Invalid revealed secret length " + secretLength);
            }
            if (secretLength > 0) {
    ...
    final class MessagingHubAnnouncement extends AbstractAttachment {
        ...
        MessagingHubAnnouncement(ByteBuffer buffer, byte transactionVersion) throws DwaException.NotValidException {
            super(buffer, transactionVersion);
            this.minFeePerByteNQT = buffer.getLong();
            int numberOfUris = buffer.get();
            if (numberOfUris > Constants.MAX_HUB_ANNOUNCEMENT_URIS) {
                throw new DwaException.NotValidException("Invalid number of URIs: " + numberOfUris);
            }
        ...
        MessagingHubAnnouncement(JSONObject attachmentData) throws DwaException.NotValidException {
            super(attachmentData);
            ...
            try {
                ...
                throw new DwaException.NotValidException("Error parsing hub terminal announcement parameters", e);
            }
        }
    ...
    final class MessagingAccountInfo extends AbstractAttachment {
        ...
        MessagingAccountInfo(ByteBuffer buffer, byte transactionVersion) throws DwaException.NotValidException {
            super(buffer, transactionVersion);
    ...
    final class MessagingAccountProperty extends AbstractAttachment {
        ...
        MessagingAccountProperty(ByteBuffer buffer, byte transactionVersion) throws DwaException.NotValidException {
            super(buffer, transactionVersion);
    ...
    final class ColoredCoinsAssetIssuance extends AbstractAttachment {
        ...
        ColoredCoinsAssetIssuance(ByteBuffer buffer, byte transactionVersion) throws DwaException.NotValidException {
            super(buffer, transactionVersion);
    ...
    final class ColoredCoinsAssetFeeRate extends AbstractAttachment {
        private final long feeTransfer;
        private final long feeAskCancel;
        private final long feeAsk;
        private final long assetId;
        ColoredCoinsAssetFeeRate(ByteBuffer buffer, byte transactionVersion) throws DwaException.NotValidException {
            super(buffer, transactionVersion);
            this.assetId = buffer.getLong();
            this.feeAsk = buffer.getLong();
            this.feeAskCancel = buffer.getLong();
            this.feeTransfer = buffer.getLong();
        }

        ColoredCoinsAssetFeeRate(JSONObject attachmentData) {
            super(attachmentData);
            this.assetId = Convert.parseUnsignedLong((String) attachmentData.get("asset"));
            this.feeAsk = Convert.parseLong(attachmentData.get("feeAsk"));
            this.feeAskCancel = Convert.parseLong(attachmentData.get("feeAskCancel"));
            this.feeTransfer = Convert.parseLong(attachmentData.get("feeTransfer"));
        }

        public ColoredCoinsAssetFeeRate(long assetId,long feeAsk,long feeAskCancel,long feeTransfer) {
        ...
        void putMyBytes(ByteBuffer buffer) {
            ...
            buffer.putLong(feeAsk);
            buffer.putLong(feeAskCancel);
            buffer.putLong(feeTransfer);
        }

        @Override
        void putMyJSON(JSONObject attachment) {
            attachment.put("asset", Long.toUnsignedString(assetId));
            attachment.put("feeAsk", feeAsk);
            attachment.put("feeAskCancel", feeAskCancel);
            attachment.put("feeTransfer", feeTransfer);
        }

        @Override
        public TransactionType getTransactionType() {
            return TransactionType.ColoredCoins.ASSET_FEE_RATE;
        }
    ...
    final class ColoredCoinsAssetTransfer extends AbstractAttachment {
        ...
        private final long feeQNT;

        ColoredCoinsAssetTransfer(ByteBuffer buffer, byte transactionVersion) throws DwaException.NotValidException {
            super(buffer, transactionVersion);
            this.assetId = buffer.getLong();
            this.quantityQNT = buffer.getLong();
            this.feeQNT = buffer.getLong();
        ...
        ColoredCoinsAssetTransfer(JSONObject attachmentData) {
            ...
            this.assetId = Convert.parseUnsignedLong((String) attachmentData.get("asset"));
            this.quantityQNT = Convert.parseLong(attachmentData.get("quantityQNT"));
            this.feeQNT = Convert.parseLong(attachmentData.get("feeQNT"));
        ...
        public ColoredCoinsAssetTransfer(long assetId, long quantityQNT) {
            this(assetId,quantityQNT,0L);
        }
        public ColoredCoinsAssetTransfer(long assetId, long quantityQNT,long feeQNT) {
            this.assetId = assetId;
            this.quantityQNT = quantityQNT;
            this.comment = null;
            this.feeQNT = feeQNT;
        ...
        @Override
        int getMySize() {
            return 8 + 8 + 8 + (getVersion() == 0 ? (2 + Convert.toBytes(comment).length) : 0);
        }
    ...
    abstract class ColoredCoinsOrderPlacement extends AbstractAttachment {
        ...
        private ColoredCoinsOrderPlacement(long assetId, long quantityQNT, long priceNQT) {
            this(assetId,quantityQNT,priceNQT,0L);
        }
        private ColoredCoinsOrderPlacement(long assetId, long quantityQNT, long priceNQT, long feeQNT) {
            this.assetId = assetId;
            this.quantityQNT = quantityQNT;
            this.priceNQT = priceNQT;
            this.feeQNT = feeQNT;
    ...
    final class ColoredCoinsAskOrderPlacement extends ColoredCoinsOrderPlacement {
        ...
        public ColoredCoinsAskOrderPlacement(long assetId, long quantityQNT, long priceNQT,long feeQNT) {
            super(assetId, quantityQNT, priceNQT,feeQNT);
        }
    ...
    abstract class ColoredCoinsOrderCancellation extends AbstractAttachment {
        ...
        private ColoredCoinsOrderCancellation(JSONObject attachmentData) {
            ...
            this.feeQNT = Convert.parseUnsignedLong((String) attachmentData.get("fee"));
        }

        private ColoredCoinsOrderCancellation(long orderId) {
            this(orderId,0);
        }
        private ColoredCoinsOrderCancellation(long orderId,long feeQNT) {
        ...
        void putMyJSON(JSONObject attachment) {
            ...
            attachment.put("fee", Long.toUnsignedString(feeQNT));
        }
    ...
    final class ColoredCoinsAskOrderCancellation extends ColoredCoinsOrderCancellation {
        ...
        public ColoredCoinsAskOrderCancellation(long orderId,long feeQNT) {
            super(orderId,feeQNT);
        }
    ...
    final class DigitalGoodsListing extends AbstractAttachment {
        ...
        DigitalGoodsListing(ByteBuffer buffer, byte transactionVersion) throws DwaException.NotValidException {
            super(buffer, transactionVersion);
    ...
    class DigitalGoodsDelivery extends AbstractAttachment {
        ...
        DigitalGoodsDelivery(ByteBuffer buffer, byte transactionVersion) throws DwaException.NotValidException {
            super(buffer, transactionVersion);
    ...
    final class UnencryptedDigitalGoodsDelivery extends DigitalGoodsDelivery implements Encryptable {
        ...
        void putMyBytes(ByteBuffer buffer) {
            if (getGoods() == null) {
                throw new DwaException.NotYetEncryptedException("Goods not yet encrypted");
            }
    ...
    final class MonetarySystemCurrencyIssuance extends AbstractAttachment {
        ...
        MonetarySystemCurrencyIssuance(ByteBuffer buffer, byte transactionVersion) throws DwaException.NotValidException {
            super(buffer, transactionVersion);
    ...
    final class ShufflingRecipients extends AbstractShufflingAttachment {
        ...
        ShufflingRecipients(ByteBuffer buffer, byte transactionVersion) throws DwaException.NotValidException {
            super(buffer, transactionVersion);
            int count = buffer.get();
            if (count > Constants.MAX_NUMBER_OF_SHUFFLING_PARTICIPANTS || count < 0) {
                throw new DwaException.NotValidException("Invalid data count " + count);
            }
    ...
    final class ShufflingCancellation extends AbstractShufflingAttachment {
        ...
        ShufflingCancellation(ByteBuffer buffer, byte transactionVersion) throws DwaException.NotValidException {
            super(buffer, transactionVersion);
            int count = buffer.get();
            if (count > Constants.MAX_NUMBER_OF_SHUFFLING_PARTICIPANTS || count <= 0) {
                throw new DwaException.NotValidException("Invalid data count " + count);
            ...
            for (int i = 0; i < count; i++) {
                ...
                if (size > Constants.MAX_PAYLOAD_LENGTH) {
                    throw new DwaException.NotValidException("Invalid data size " + size);
                }
            ...
            count = buffer.get();
            if (count > Constants.MAX_NUMBER_OF_SHUFFLING_PARTICIPANTS || count <= 0) {
                throw new DwaException.NotValidException("Invalid keySeeds count " + count);
            }
    ...
    final class TaggedDataUpload extends TaggedDataAttachment {
        ...
        public TaggedDataUpload(String name, String description, String tags, String type, String channel, boolean isText,
                                String filename, byte[] data) throws DwaException.NotValidException {
            ...
            if (isText && !Arrays.equals(data, Convert.toBytes(Convert.toString(data)))) {
                throw new DwaException.NotValidException("Data is not UTF-8 text");
            }
        }
