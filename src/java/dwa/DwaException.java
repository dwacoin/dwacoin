...
public abstract class DwaException extends Exception {

    protected DwaException() {
        super();
    }

    protected DwaException(String message) {
        super(message);
    }

    protected DwaException(String message, Throwable cause) {
        super(message, cause);
    }

    protected DwaException(Throwable cause) {
        super(cause);
    }

    public static abstract class ValidationException extends DwaException {
    ...
    public static final class DwaIOException extends IOException {

        public DwaIOException(String message) {
            super(message);
        }

        public DwaIOException(String message, Throwable cause) {
            super(message, cause);
        }
