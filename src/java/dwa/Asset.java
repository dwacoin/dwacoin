...
public final class Asset {
    ...
    public static Asset getAsset(String normalizedName) {
        return assetTable.getBy(new DbClause.StringClause("LOWER(name)", normalizedName));
    }
