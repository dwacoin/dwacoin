...
import static dwa.user.JSONResponses.LOCK_ACCOUNT;
...
public final class UnlockAccount extends UserServlet.UserRequestHandler {
    ...
    JSONStreamAware processRequest(HttpServletRequest req, User user) throws IOException {
        ...
        if (account == null) {
            ...
            try (DbIterator<? extends Transaction> transactions = Dwa.getTransactionProcessor().getAllUnconfirmedTransactions()) {
            ...
            int blockchainHeight = Dwa.getBlockchain().getLastBlock().getHeight();
            try (DbIterator<? extends Block> blockIterator = Dwa.getBlockchain().getBlocks(accountId, 0)) {
            ...
            try (DbIterator<? extends Transaction> transactionIterator = Dwa.getBlockchain().getTransactions(accountId, (byte) -1, (byte) -1, 0, false)) {
