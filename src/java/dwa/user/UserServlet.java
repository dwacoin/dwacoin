...
import static dwa.user.JSONResponses.DENY_ACCESS;
import static dwa.user.JSONResponses.INCORRECT_REQUEST;
import static dwa.user.JSONResponses.POST_REQUIRED;

public final class UserServlet extends HttpServlet  {

    abstract static class UserRequestHandler {
        abstract JSONStreamAware processRequest(HttpServletRequest request, User user) throws DwaException, IOException;
        boolean requirePost() {
            return false;
        }
    }

    private static final boolean enforcePost = Dwa.getBooleanProperty("dwa.uiServerEnforcePOST");
    ...
    private void process(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        } catch (RuntimeException|DwaException e) {
