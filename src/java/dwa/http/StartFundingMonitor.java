...
import static dwa.http.JSONResponses.MONITOR_ALREADY_STARTED;
 ...
 * <p>
 * A funding monitor will transfer DWA, ASSET or CURRENCY from the funding account
 ...
 * <p>
 * DWA amounts are specified with 8 decimal places.  Asset and Currency decimal places
...
public final class StartFundingMonitor extends APIServlet.APIRequestHandler {
     ...
     * @throws  DwaException        Unable to process request
     */
    @Override
