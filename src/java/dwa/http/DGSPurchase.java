...
import static dwa.http.JSONResponses.INCORRECT_DELIVERY_DEADLINE_TIMESTAMP;
import static dwa.http.JSONResponses.INCORRECT_PURCHASE_PRICE;
import static dwa.http.JSONResponses.INCORRECT_PURCHASE_QUANTITY;
import static dwa.http.JSONResponses.MISSING_DELIVERY_DEADLINE_TIMESTAMP;
import static dwa.http.JSONResponses.UNKNOWN_GOODS;
...
public final class DGSPurchase extends CreateTransaction {
    ...
    protected JSONStreamAware processRequest(HttpServletRequest req) throws DwaException {
        ...
        try {
            ...
            if (deliveryDeadline <= Dwa.getEpochTime()) {
