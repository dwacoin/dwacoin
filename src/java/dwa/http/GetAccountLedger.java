 ...
 * account ledger tracks all account changes as determined by the dwa.ledgerAccounts,
 * dwa.ledgerLogUnconfirmed and dwa.ledgerTrimKeep properties.
 * </p>
 * <table>
 ...
 *           The administrator password is required if more than dwa.maxAPIRecords entries are to be searched.
 *       </td>
 *     </tr>
 *     <tr>
 *       <td>event</td>
 ...
 *           The maximum number of entries returned is limited by the dwa.maxAPIRecords property
 ...
 *     <tr>
 *       <td>DWA_BALANCE</td>
 *       <td>Change in the DWA balance for the account.  There is no 'holding'.</td>
 *     </tr>
 *     <tr>
 ...
 *     </tr>
 *     <tr>
 *       <td>UNCONFIRMED_DWA_BALANCE</td>
 *       <td>Change in the unconfirmed DWA balance for the account.  There is no 'holding'.</td>
 *     </tr>
 *   </tbody>
 * </table>
 */
public class GetAccountLedger extends APIServlet.APIRequestHandler {
     ...
     * @return                      API response
     * @throws  DwaException        Invalid request
     */
    @Override
