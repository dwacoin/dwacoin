...
import dwa.http.EventListener.PendingEvent;
 ...
 * dwa.apiEventTimeout will be used if no timeout value is specified or
 * if the requested timeout is greater than dwa.apiEventTimeout.</li>
 * </ul>
 *
