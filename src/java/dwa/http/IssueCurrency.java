...
/**
 * Issue a currency on the DWA blockchain
 * <p>
 * A currency is the basic block of the DWA Monetary System it can be exchanged with DWA, transferred between accounts,
 ...
 * For {@link dwa.CurrencyType#RESERVABLE} currency
 * <li>minReservePerUnitNQT - the minimum DWA value per unit to allow the currency to become active
 * For {@link dwa.CurrencyType#RESERVABLE} currency
 ...
 * For {@link dwa.CurrencyType#MINTABLE} currency
 * <li>maxDifficulty - for mint-able currency, the exponent of the final difficulty.
 * For {@link dwa.CurrencyType#MINTABLE} currency
 * <li>algorithm - the hashing {@link dwa.crypto.HashFunction algorithm} used for minting.
 * For {@link dwa.CurrencyType#MINTABLE} currency
 * </ul>
 * <p>
 * Constraints
 * <ul>
 * <li>A given currency can not be neither {@link dwa.CurrencyType#EXCHANGEABLE} nor {@link dwa.CurrencyType#CLAIMABLE}.<br>
 * <li>A {@link dwa.CurrencyType#RESERVABLE} currency becomes active once the blockchain height reaches the currency issuance height.<br>
 ...
 * When a {@link dwa.CurrencyType#RESERVABLE} becomes active, in case it is {@link dwa.CurrencyType#CLAIMABLE} the DWA used for
 * reserving the currency are locked until they are claimed back.
 * When a {@link dwa.CurrencyType#RESERVABLE} becomes active, in case it is non {@link dwa.CurrencyType#CLAIMABLE} the DWA used for
 * reserving the currency are sent to the issuer account as crowd funding.
 * <li>When issuing a {@link dwa.CurrencyType#MINTABLE} currency, the number of units per {@link dwa.http.CurrencyMint} cannot exceed 0.01% of the
 ...
 * difficulty increases linearly with the number units minted per {@link dwa.http.CurrencyMint}<br>
 * </ul>
 *
 * @see dwa.CurrencyType
 * @see dwa.crypto.HashFunction
 */
