...
public final class JSONResponses {
    ...
    public static final JSONStreamAware DUPLICATE_ASSET_NAME = incorrect("name", "(duplicate asset name)");
    ...
    public static final JSONStreamAware INCORRECT_ADMIN_PASSWORD = incorrect("adminPassword", "(the specified password does not match dwa.adminPassword)");
    ...
    static {
        JSONObject response = new JSONObject();
        response.put("errorCode", 8);
        response.put("errorDescription", "Administrator's password is not configured. Please set dwa.adminPassword");
    ...
    static {
        JSONObject response = new JSONObject();
        response.put("errorCode", 8);
        response.put("errorDescription", "Poll results no longer available, set dwa.processPolls=true and rescan");
    ...
    public static final JSONStreamAware INCORRECT_SECRET_PHRASE;
    static {
        JSONObject response = new JSONObject();
        response.put("errorCode", 3);
        response.put("errorDescription", "incorrect secretPhrase");
        INCORRECT_SECRET_PHRASE = JSON.prepare(response);
    }
