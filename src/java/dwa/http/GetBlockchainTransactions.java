...
public final class GetBlockchainTransactions extends APIServlet.APIRequestHandler {
    ...
    protected JSONStreamAware processRequest(HttpServletRequest req) throws DwaException {
        ...
        if(accountString == null || accountString.equalsIgnoreCase("")){
            try (DbIterator<? extends Transaction> iterator = Dwa.getBlockchain().getAllTransactionsOrderByTimestamp()) {
            ...
            try (DbIterator<? extends Transaction> iterator = Dwa.getBlockchain().getTransactions(accountId, numberOfConfirmations,
