...
public enum APIEnum {
    ...
    UNCONFIRMED_TRANSACTION("getUnconfirmedTransactionSummary", GetUnconfirmedTransactionSummary.instance),
    ...
    SET_ASSET_FEE_RATE("setAssetFeeRate", SetAssetFeeRate.instance),
    GET_ASSET_FEE_RATE("getAssetFeeRate", GetAssetFeeRate.instance),
    ...
    SET_ACCOUNT_NOTIFY("setAccountNotify", SetAccountNotify.instance);
