...
package dwa.env.service;

import dwa.Dwa;
import dwa.env.LookAndFeel;

import javax.swing.*;

@SuppressWarnings("UnusedDeclaration")
public class DwaService_ServiceManagement {
    ...
    public static String[] serviceGetInfo() {
        return new String[]{
                "DWA Server", // Long name
                "Manages the DWA cryptographic currency protocol", // Description
                "true", // IsAutomatic
                "true", // IsAcceptStop
                "", // failure exe
                "", // args failure
    ...
    public static boolean serviceIsCreate() {
        return JOptionPane.showConfirmDialog(null, "Do you want to install the DWA service ?", "Create Service", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION;
    }
    ...
    public static boolean serviceIsDelete() {
        return JOptionPane.showConfirmDialog(null, "This DWA service is already installed. Do you want to delete it ?", "Delete Service", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION;
    }
