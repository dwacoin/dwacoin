...
public interface Transaction {
    ...
    interface Builder {
        ...
        Transaction build() throws DwaException.NotValidException;

        Transaction build(String secretPhrase) throws DwaException.NotValidException;
    ...
    void validate() throws DwaException.ValidationException;
