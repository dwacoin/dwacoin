...
browser, without stopping the java process, and go to http://localhost:2876 ,
...
The java process communicates with peers on port 2874 tcp by default. If you are
...
The user interface is available on port 2876. This port also accepts http API
...
In addition to the default user interface at http://localhost:2876 , the
following urls are available:

http://localhost:2876/test - a list of all available http API requests, very
...
http://localhost:2876/test?requestType=<specificRequestType> - same as above,
but only shows the form for the request type specified.

http://localhost:2876/doc - a javadoc documentation for client developers who
